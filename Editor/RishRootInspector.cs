...
namespace RishUI.Editor
{
    ...
    public partial class RishRootInspector : UnityEditor.Editor
    {
        ...
        private Label VisualTreeSizeLabel { get; set; }
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            if(Application.isPlaying)
            {
                if (target is RishRoot root)
                {
                    ...
                    container.Add(VisualTreeSizeLabel);
                    container.Add(new ToolbarSpacer
                    {
                        style =
                        {
        ...
        private void OnDisable()
        {
            if (target is RishRoot root)
            {
                root.OnStep.Remove(Sappy.OnStep);
            }
        }
        ...
        {
            TreeSizeLabel.text = $"Tree Size: {root.GetTreeSize()}";
            VisualTreeSizeLabel.text = $"Visual Tree Size: {root.GetVisualTreeSize()}";
