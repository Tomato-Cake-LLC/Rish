...
namespace RishUI
{
    internal class Tree
    {
...
#if UNITY_EDITOR
        public int GetSize() => RootNode?.GetSize() ?? 0;
        public int GetVisualSize() => RootNode?.GetVisualSize() ?? 0;
#endif
        ...
        public void Dirty(Node node, bool immediate) => DirtyQueue.Dirty(node, immediate);
