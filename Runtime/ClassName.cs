...
namespace RishUI
{
    ...
    public struct ClassName : IPointer<ManagedClassName>, IEnumerable<string>, IEquatable<ClassName>
    {
        ...
        private ulong _id;
        ulong IPointer<ManagedClassName>.ID => _id;
        ...
        public bool Contains(FixedString32Bytes element) => Contains(element.Value);
        public bool Contains(FixedString64Bytes element) => Contains(element.Value);
        public bool Contains(FixedString128Bytes element) => Contains(element.Value);
        public bool Contains(FixedString512Bytes element) => Contains(element.Value);
        public bool Contains(FixedString4096Bytes element) => Contains(element.Value);
        public bool Contains(RishString element) => Contains(element.value);
