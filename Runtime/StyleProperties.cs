...
#if UNITY_6000_2_OR_NEWER
using TextAutoSize = UnityEngine.UIElements.TextAutoSize;
#endif
...
namespace RishUI
{
    ...
    public readonly struct StyleBackgroundHorizontalPosition : IStyleValue<BackgroundPosition>
    {
        ...
        public StyleBackgroundHorizontalPosition(BackgroundPosition value) : this(value, RishStyleKeyword.Undefined) { }
        ...
        public static implicit operator StyleBackgroundHorizontalPosition(BackgroundPosition v) => new(v);
    ...
    public readonly struct StyleBackgroundVerticalPosition : IStyleValue<BackgroundPosition>
    {
        ...
        public StyleBackgroundVerticalPosition(BackgroundPosition value) : this(value, RishStyleKeyword.Undefined) { }
        ...
        public static implicit operator StyleBackgroundVerticalPosition(BackgroundPosition v) => new(v);
    ...
    public readonly struct StyleMaterialDefinition : IStyleValue<MaterialDefinition>
    {
        public readonly MaterialDefinition value;
        MaterialDefinition IStyleValue<MaterialDefinition>.value => value;
        
        public readonly RishStyleKeyword keyword;
        RishStyleKeyword IStyleValue<MaterialDefinition>.keyword => keyword;

        public StyleMaterialDefinition(MaterialDefinition v) : this(v, RishStyleKeyword.Undefined) { }
        public StyleMaterialDefinition(Material v) : this(MaterialDefinition.FromMaterial(v), RishStyleKeyword.Undefined) { }
        public StyleMaterialDefinition(RishStyleKeyword keyword) : this(default, keyword) { }
        private StyleMaterialDefinition(MaterialDefinition v, RishStyleKeyword keyword)
        {
            this.keyword = keyword;
            this.value = v;
        }
        ...
        public static implicit operator StyleMaterialDefinition(RishStyleKeyword keyword) => new(keyword);
        public static implicit operator StyleMaterialDefinition(MaterialDefinition v) => new(v);
        public static implicit operator StyleMaterialDefinition(Material v) => new(v);

        public bool AsNative(out UnityEngine.UIElements.StyleMaterialDefinition result)
        {
            result = this;
            return true;
        }
        
        public static implicit operator UnityEngine.UIElements.StyleMaterialDefinition(StyleMaterialDefinition style) => style.keyword switch
        {
            RishStyleKeyword.Undefined => style.value,
            _ => style.keyword.ToNative()
        };

        public static implicit operator StyleMaterialDefinition(UnityEngine.UIElements.StyleMaterialDefinition style) =>
            style.keyword == StyleKeyword.Undefined ? style.value : style.keyword.FromNative();
    }
#endif
    
#if UNITY_6000_3_OR_NEWER
    public readonly struct StyleRatio : IStyleValue<Ratio>
    {
        public readonly Ratio value;
        Ratio IStyleValue<Ratio>.value => value;
        
        public readonly RishStyleKeyword keyword;
        RishStyleKeyword IStyleValue<Ratio>.keyword => keyword;

        public StyleRatio(Ratio value) : this(value, RishStyleKeyword.Undefined) { }
        public StyleRatio(float value) : this(new Ratio(value), RishStyleKeyword.Undefined) { }
        public StyleRatio(RishStyleKeyword keyword) : this(default, keyword) { }
        private StyleRatio(Ratio value, RishStyleKeyword keyword)
        {
            this.keyword = keyword;
            this.value = value;
        }
        ...
        public static implicit operator StyleRatio(RishStyleKeyword keyword) => new(keyword);
        public static implicit operator StyleRatio(Ratio v) => new(v);
        public static implicit operator StyleRatio(float v) => new(v);

        public bool AsNative(out UnityEngine.UIElements.StyleRatio result)
        {
            result = this;
            return true;
        }
        
        public static implicit operator UnityEngine.UIElements.StyleRatio(StyleRatio style) => style.keyword switch
        {
            RishStyleKeyword.Undefined => style.value,
            _ => style.keyword.ToNative()
        };

        public static implicit operator StyleRatio(UnityEngine.UIElements.StyleRatio style) =>
            style.keyword == StyleKeyword.Undefined ? style.value : style.keyword.FromNative();
    }
#endif
...
#if UNITY_6000_2_OR_NEWER
    public readonly struct StyleTextAutoSize : IStyleValue<TextAutoSize>
    {
        public readonly TextAutoSize value;
        TextAutoSize IStyleValue<TextAutoSize>.value => value;
        
        public readonly RishStyleKeyword keyword;
        RishStyleKeyword IStyleValue<TextAutoSize>.keyword => keyword;

        public StyleTextAutoSize(TextAutoSize v) : this(v, RishStyleKeyword.Undefined) { }
        public StyleTextAutoSize(RishStyleKeyword keyword) : this(default, keyword) { }
        private StyleTextAutoSize(TextAutoSize v, RishStyleKeyword keyword)
        {
            this.keyword = keyword;
            this.value = v;
        }
        ...
        public static implicit operator StyleTextAutoSize(RishStyleKeyword keyword) => new(keyword);
        public static implicit operator StyleTextAutoSize(TextAutoSize v) => new(v);

        public bool AsNative(out UnityEngine.UIElements.StyleTextAutoSize result)
        {
            result = this;
            return true;
        }
        
        public static implicit operator UnityEngine.UIElements.StyleTextAutoSize(StyleTextAutoSize style) => style.keyword switch
        {
            RishStyleKeyword.Undefined => style.value,
            _ => style.keyword.ToNative()
        };

        public static implicit operator StyleTextAutoSize(UnityEngine.UIElements.StyleTextAutoSize style) =>
            style.keyword == StyleKeyword.Undefined ? style.value : style.keyword.FromNative();
    }
#endif
