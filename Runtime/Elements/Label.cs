...
{
    public partial class Label : TextElement, IVisualElement<LabelProps>, IMountingListener
    {
        ...
        {
            Parent = parent;
            Parent?.RegisterCallback<VisualChangeEvent>(Sappy.OnVisualChange.Callback);
        }

        void IMountingListener.ElementWillUnmount()
        {
            Parent?.UnregisterCallback<VisualChangeEvent>(Sappy.OnVisualChange.Callback);
            Parent = null;
        ...
        public Label()
        {
            ...
            RegisterCallback<VisualChangeEvent>(Sappy.OnVisualChange.Callback);
