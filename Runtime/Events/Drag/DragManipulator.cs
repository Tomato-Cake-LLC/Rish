...
namespace RishUI.Events
{
    public partial class DragManipulator : ToolkitManipulator
    {
        ...
        protected override void RegisterCallbacks()
        {
            ...
            target.RegisterCallback<PointerEnterEvent>(Sappy.OnPointerEnter.Callback);
            target.RegisterCallback<PointerLeaveEvent>(Sappy.OnPointerLeave.Callback);
            target.RegisterCallback<PointerDownEvent>(Sappy.OnPointerDown.Callback);
            target.RegisterCallback<PointerUpEvent>(Sappy.OnPointerUp.Callback);
            target.RegisterCallback<PointerMoveEvent>(Sappy.OnPointerMove.Callback);
            target.RegisterCallback<PointerCaptureEvent>(Sappy.OnPointerCaptured.Callback);
            target.RegisterCallback<PointerCaptureOutEvent>(Sappy.OnPointerReleased.Callback);
        }

        protected override void UnregisterCallbacks()
        {
            target.UnregisterCallback<PointerEnterEvent>(Sappy.OnPointerEnter.Callback);
            target.UnregisterCallback<PointerLeaveEvent>(Sappy.OnPointerLeave.Callback);
            target.UnregisterCallback<PointerDownEvent>(Sappy.OnPointerDown.Callback);
            target.UnregisterCallback<PointerUpEvent>(Sappy.OnPointerUp.Callback);
            target.UnregisterCallback<PointerMoveEvent>(Sappy.OnPointerMove.Callback);
            target.UnregisterCallback<PointerCaptureEvent>(Sappy.OnPointerCaptured.Callback);
            target.UnregisterCallback<PointerCaptureOutEvent>(Sappy.OnPointerReleased.Callback);
        }
