...
namespace RishUI.Events
{
    ...
    internal partial class ToolkitCallbackWrapper<T> : IToolkitCallbackWrapper where T : EventBase<T>, new()
    {
        ...
        private SapTarget<EventCallback<T>> _SappyHandleEvent;
        private SapTarget<EventCallback<T>> SappyHandleEvent => _SappyHandleEvent ??= new SapTarget<EventCallback<T>>(HandleEvent);
