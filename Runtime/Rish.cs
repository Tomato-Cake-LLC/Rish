...
namespace RishUI
{
    public static partial class Rish
    {
        ...
        public static ManagedContext GetOwnerContext<T1, T2>(T1 reference) where T1 : struct, IPointer<T2> where T2 : class, IManaged
        {
            try
            {
                return GetPool<T2>()?.GetWrapper<T2>(reference.ID)?.OwnerContext;
            }
            catch (Exception _)
            {
                return null;
        ...
        public static ManagedContext GetOwnerContext<T>(ulong id) where T : class, IManaged
        {
            try
            {
                return GetManaged<T>(id)?.OwnerContext;
            }
            catch (Exception _)
            {
                return null;
