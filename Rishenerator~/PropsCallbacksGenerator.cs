...
{{");
    ...
    protected partial class SappyPropsHolder
    {{
        private global::Sappy.SapTarget<{item.TypeFullName}> _{callbackName};
        public global::Sappy.SapTarget<{item.TypeFullName}> {callbackName} => _{callbackName} ??= new global::Sappy.SapTarget<{item.TypeFullName}>(Element.{callbackName});
    }}
